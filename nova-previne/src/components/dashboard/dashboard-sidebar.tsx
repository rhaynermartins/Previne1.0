  ...
  return (
    <aside className="sticky top-20 z-30 rounded-lg border border-[#d9ebf2] bg-white p-2 shadow-[0_14px_38px_rgba(0,59,111,0.08)] sm:p-3 lg:top-28">
      <div className="hidden border-b border-[#edf4f8] px-3 pb-4 lg:block">
        <p className="text-sm font-bold text-dark-blue">Área do paciente</p>
      ...
      <nav
        aria-label="Navegação do dashboard do paciente"
        ...
        {patientNavItems.map((item) => {
          ...
          return (
            <Link
              ...
              className={cn(
                "flex min-h-11 shrink-0 snap-start items-center gap-2 rounded-lg px-3 text-sm font-semibold transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-blue",
                active
