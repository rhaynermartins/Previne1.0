...
const variants = {
  blue: "border-[#b9e4f4] bg-light-blue text-dark-blue shadow-[0_6px_16px_rgba(0,143,211,0.07)]",
  green: "border-[#b7ead3] bg-light-green text-[#006b3d] shadow-[0_6px_16px_rgba(0,158,90,0.08)]",
  gray: "border-[#e0e7ee] bg-[#f6f8fa] text-gray-text shadow-[0_6px_16px_rgba(0,59,111,0.04)]",
