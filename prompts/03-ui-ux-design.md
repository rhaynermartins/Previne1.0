Adicione ao projeto um arquivo `AGENTS.md` na raiz com as instruções abaixo. Essas instruções devem guiar todas as decisões de frontend, UI, UX, responsividade, identidade visual e qualidade de interface neste projeto.
